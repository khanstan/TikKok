        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SourceUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersBlocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersBlocks_AspNetUsers_BlockedUserId",
                        column: x => x.BlockedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersBlocks_AspNetUsers_SourceUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersFollows_AspNetUsers_FollowedUserId",
                        column: x => x.FollowedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UsersFollows_AspNetUsers_SourceUserId",
                        column: x => x.SourceUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersBlocks_BlockedUserId",
                table: "UsersBlocks",
                column: "BlockedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersBlocks_SourceUserId",
                table: "UsersBlocks",
                column: "SourceUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFollows_FollowedUserId",
                table: "UsersFollows",
                column: "FollowedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFollows_SourceUserId",
                table: "UsersFollows",
                column: "SourceUserId");
